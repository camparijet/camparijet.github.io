...
** 全体の流れ
   ...
   締め切りが設定されているものが多いです。
   予定日の３ヶ月前から動き出しておくことを強くおすすめします。

   困ったらこちら: [[https://www.berlin.de/ba-friedrichshain-kreuzberg/politik-und-verwaltung/aemter/amt-fuer-buergerdienste/standesamt/artikel.162483.php][Berlin Administration]]
   ...
   - After birth
     - Geburtsurkunde: [[https://service.berlin.de/dienstleistung/318960/][Berlin Administration]] (出生7日以内)
     - 出生届+戸籍謄本: [[https://www.de.emb-japan.go.jp/nihongo/konsular/003koseki.html#03shussei][在ドイツ日本大使館]] (3ヶ月以内, Geburtsurkundeが必要)
     - Reisepass/パスポート: [[https://www.de.emb-japan.go.jp/nihongo/konsular/002pass.html#01shinki][在ドイツ日本大使館]] (戸籍謄本が必要)
     - Anmeldung der Geburt: 市民登録（パスポートが必要）
     - Aufenthaltserlaubnis für in Bundersgebiet geborene Kinder: [[https://service.berlin.de/dienstleistung/324269/][Berlin Administration]] (Meldebescheinigung, パスポートが必要)
     - Kindergeld: [[https://www.arbeitsagentur.de/familie-und-kinder/infos-rund-um-kindergeld][Bundesagentur für Arbeit]] (Aufenthaltserlaubnis手続き後に発行されるIdentifikationnummerが必要)
     - Elterngeld: [[https://familienportal.de/familienportal/familienleistungen/elterngeld/faq][FAQ in familienportal.de]] see "Wie kann ich Elterngeld beantragen?" (Identifikationnummerが必要)
     - Kita Guteschein: [[https://service.berlin.de/dienstleistung/324873/][Berlin Administration]]
...
*** Before birth
    ...
    最期の「原本」はなにかよくわからなかったので、手続きの時にBerlinのStandesamt（出生局）に聞いたら担当者が国別マニュアルを見せてくれました。
    それによると、日本人の場合、資料上記３つめの「原本」は「両親世帯のアポスティーユ付きの戸籍謄本」でした。

    ややこしいのですが、GeburtsurkundeとVerheiratekundeは在ドイツ日本大使館に戸籍謄本を持参すると作ってもらえます。
    これら２つの書類発行は日本国で閉じた手続きです。
    従ってこの2つの書類を作成するために大使館に提出する戸籍謄本については、アポスティーユの有無は関係ありません。
